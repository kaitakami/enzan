...
const backlog = () => {
  return (
    <Layout>
      <section className='max-w-6xl mx-auto pt-20 space-y-12 px-7 flex flex-col items-center md:block m-auto'>
        <h1 className='scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl text-center'>Backlog</h1>

          ...
          <section className="from-[#f1f1f1] via-slate-100 to-[#fafafa] dark:from-slate-900 dark:via-slate-800 dark:to-slate-800 h-screen sm:pt-16 pt-5 bg-gradient-to-b max-h-[1200px] relative">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
              ...
              <div className="space-y-5">
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none bg-gradient-to-b from-slate-900 via-slate-800 to-slate-800 md:text-7xl lg:text-8xl bg-clip-text text-transparent dark:text-slate-100 sm:max-w-xs sm:px-0 md:max-w-2xl  lg:max-w-4xl py-8 m-auto backdrop-blur-3xl">{siteConfig.secondDescription}</h1>
                <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400 backdrop-blur-xl">{siteConfig.description}</p>

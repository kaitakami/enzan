...
const Projects = () => {
  ...
  return (
    <div className="px-4 md:px-8 w-full m-auto">
      <section className="max-w-6xl space-y-5 m-auto w-full">
        <h2 className="pt-10 scroll-m-20 border-b border-b-slate-200 pb-2 text-4xl font-semibold tracking-tight transition-colors first:mt-0 dark:border-b-slate-700">Proyectos públicos</h2>
      ...
      <section className="max-w-6xl m-auto pt-10 w-full">
        ...
        <div className="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3 justify-center py-8 w-full">
          <Link href="#" className="block w-full p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
